...
let tempFolder = 'temp/etc/designs/kaousa/www-goldwell-com/';
let targetFolder = 'target/etc/designs/kaousa/www-goldwell-com/';
let designPath = 'etc/designs/kaousa/www-goldwell-com/';
let subDesignPath = 'etc/designs/kaousa/www-goldwell-com/sub/';
let clientLibsToMinify = ['component','contact-us','sign-up','unsubscription','booking-form'];
...
let env = argv.env;
let sub = argv.sub;
let brandName = 'www-goldwell-com/';
