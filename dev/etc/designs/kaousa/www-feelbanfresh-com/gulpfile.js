...
let tempFolder = 'temp/etc/designs/kaousa/www-feelbanfresh-com/';
let targetFolder = 'target/etc/designs/kaousa/www-feelbanfresh-com/';
let designPath = 'etc/designs/kaousa/www-feelbanfresh-com/';
let subDesignPath = 'etc/designs/kaousa/www-feelbanfresh-com/sub/';
let clientLibsToMinify = ['component', 'contact-us', 'sign-up', 'unsubscription'];
...
let env = argv.env;
let sub = argv.sub;
let brandName = 'www-feelbanfresh-com/';
//let brandFolder = '/etc/designs/kaousa/'+brandName+'/';
//let targettedFolder = 'jcr_root';
//http://sit1dig001:RBWvhFxk3K5w@elb-ver-wcm-auth-472389826.ap-northeast-1.elb.amazonaws.com/';
