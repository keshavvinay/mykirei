 ...
 * 2) Install npm modules using npm install --save-dev <module name>: gulp, gulp-compass,  , run-sequence, gulp-clean,
...
let tempFolder = 'temp/etc/designs/kaousa/curel-japan/';
let targetFolder = 'target/etc/designs/kaousa/curel-japan';
let designPath = 'etc/designs/kaousa/www-curel-com/';
let subDesignPath = 'etc/designs/kaousa/www-curel-com/sub/';
let clientLibsToMinify = ['component','contact-us','newsletter','unsubscription'];
...
if (env == 'sit'){
    ...
    target = 'https://auth.virginia.sites.kao.com/';
...
gulp.task('build', function() {
    if(minificationRequired) {
        ...
        runSequence('compass','copy-files-to-temp', 'copy-files-to-target',
            function() {
                // do nothing
            }
        );
