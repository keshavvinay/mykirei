$(document).ready(function () {
    ...
    $(document).on('click', '.dropdown-list-wrapper .g-ListP ul li', function () {
        if ($(this).closest('.g-ListP').siblings('.form_row').find('input').val() != "") {
            $(this).closest('.g-ListP').siblings('.form_row').find('.help-block').hide();
        }
    })

    $(document).on('click', '.date-group-box .dob-wrapper .g-ListP ul li', function () {
        if ($(this).closest('.g-ListP').siblings('.form_row').find('input').val() != "") {
            $(this).closest('.g-ListP').siblings('.form_row').find('.help-block').hide();
        }
    })
    ...
    form.validate({
        ...
        submitHandler: function (form) {
            ...
            if ($('input[name="brand-news-subscription"]').is(":checked")) {
                bns = true;
            } else {
                bns = '';
            }
