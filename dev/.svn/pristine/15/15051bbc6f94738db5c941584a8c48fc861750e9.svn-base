 ...
 * 2) Install npm modules using npm install --save-dev <module name>: gulp@3.9.1, gulp-compass,  , run-sequence, gulp-clean,
...
let tempFolder = 'temp/etc/designs/kaousa/www-guhl-com/';
let targetFolder = 'target/etc/designs/kaousa/www-guhl-com/';
let designPath = 'etc/designs/kaousa/www-guhl-com/';
let subDesignPath = 'etc/designs/kaousa/www-guhl-com/sub/';
