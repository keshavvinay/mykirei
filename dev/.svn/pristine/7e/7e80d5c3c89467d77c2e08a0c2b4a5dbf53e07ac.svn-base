...
let tempFolder = 'temp/etc/designs/kaousa/www-biore-com/';
let targetFolder = 'target/etc/designs/kaousa/www-biore-com/';
let designPath = 'etc/designs/kaousa/www-biore-com/';
let subDesignPath = 'etc/designs/kaousa/www-biore-com/sub/';
